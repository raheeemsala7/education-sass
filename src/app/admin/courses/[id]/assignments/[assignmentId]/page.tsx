import AssginmentStepLayout from '@/features/assginment/_components/layout/assginment-step-layout'
...
const page = async ({ params }: IProps) => {
  ...
  return (
    <div className='px-4'>
      ...
      <AssginmentStepLayout assginmentId={assignmentId} courseId={id} />
    </div>
  )
}
